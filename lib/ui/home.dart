...
final Color themeColor = Color.fromARGB(255, 231, 225, 220);
  ...
  List<Widget> _buildActions() {
    return <Widget>[
      ...
      MaterialButton(
        ...
        onPressed: () {
          html.window.open("mailto:fajars328@gmail.com", "Email");
        },
      ),
    ];
  }
...
//        _buildNavigationArrows(),
  ...
  final workingExperienceList = [
    Education('Movie App From TMDB API', 'mockup/dua.png'),
    Education('Tabunganku App with Firebase', 'mockup/tabunganku.png'),
    Education('Aspirasi ku App with Firebase', 'mockup/aspirasi.png'),
    Education('Absensi App with Firebase', 'mockup/presensi.png'),
  ];
  ...
  Widget _buildEducationSummary() {
    return Text(
      'below are some of my standalone projects with dart and flutter',
      style: TextStyles.body,
    );
  }
        ...
        Container(
          ...
          decoration: BoxDecoration(
              ...
              image: DecorationImage(
                  image: AssetImage("${education.image}"), fit: BoxFit.cover)),
          child: Column(
    ...
    return Row(
      ...
      children: <Widget>[
        GestureDetector(
          onTap: () {
            html.window.open(
                "https://www.linkedin.com/in/fajar-sidiq-1a436a26b/",
                "LinkedIn");
          },
          child: Image.network(
            Assets.linkedin,
        ...
        GestureDetector(
          onTap: () {
            html.window.open("https://github.com/fajarmuhammadsidiq", "Github");
          },
          child: Image.network(
            Assets.github,
            color: Color(0xFF45405B),
